...
\begin{document}
	...
	\begin{tikzpicture}[remember picture,overlay]
		\node[inner sep=0pt, opacity=0.5] (logo) at ([xshift=-5cm,yshift=4.5cm]current page.center) {\includegraphics[width=1\paperwidth]{goGreenLogoGrayscale}}; %TODO: higher resolution needed!
	\end{tikzpicture}
