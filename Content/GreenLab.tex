...
\begin{abc}
	...
	Facebook:  \url{https://www.facebook.com/igem.goesgreen/?fref=ts} %TODO Links
	...
	\suggestion{Keep it simple!} %TODO Knowledge, Keep, Know
	...
	\suggestion{V}
	Inhalt... %TODO Vacuum, value, ventilation, view, visit, volume, vote
...
\begin{suggest}{Use recycling paper}
	...
	\begin{itemize}
		...
		\item  The total energy consumption is 3-4 times lower. %TODO Quellen
