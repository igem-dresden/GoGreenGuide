	...
	\begin{abc}
		\suggestion{A item} with text
		\suggestion{B item} With more awesome text
		\suggestion{C item} With enough text to have a line break. This is a very good suggestion and everyone should consider following it. Believe me. It's amazing! The best suggestion in the world! Not joking!
		\suggestion{more} and so on...
	\end{abc}
